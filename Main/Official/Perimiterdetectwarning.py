...
def detect_and_draw_circles(image_path):
    ...
    if best_circles is not None:
        ...
        for i in best_circles[0, :1]:
            ...
            #                     messages.append("Warning: Overlapping beyond perimeter")
            ...
            #     messages.append("Good: Edge within the perimeter")
            # else:
            #     messages.append("Warning: No edge within the perimeter")
    ...
    return img, offset_image, messages
