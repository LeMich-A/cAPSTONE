...
# left_config = camera_left.create_preview_configuration(main={"size": (640, 480)})
# right_config = camera_right.create_preview_configuration(main={"size": (640, 480)})

# camera_left.configure(left_config)
# camera_right.configure(right_config)
...
#     # Release resources and destroy all windows before termination
# camera_left.stop()
# camera_right.stop()
